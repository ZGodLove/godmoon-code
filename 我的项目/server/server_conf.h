...
extern struct server_conf_st server_conf; // 服务器信息实例
extern int serversd;                      // 服务器socket
extern struct sockaddr_in sndaddr;        // 发送端的地址,服务器地址
